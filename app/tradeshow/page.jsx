...
const Page = () => {
  ...
  const SubHeadingText = {
    pageref: "PLASTINDIA 2026 > Overview",
    title: "PLASTINDIA  2026",
    description: "Gateway to Global Plastic Innovations",
    content:
      "Discover PLASTINDIA 2026 , where the future of plastics comes alive. Explore our <strong> rich legacy, meet the team behind this landmark event, </strong> and dive into dynamic exhibition. Celebrate <strong> decades of innovation and excellence in the plastics industry. </strong> ",
  };
